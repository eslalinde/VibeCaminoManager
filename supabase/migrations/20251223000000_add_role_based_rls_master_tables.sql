-- ==============================================
-- ROLE-BASED RLS FOR MASTER TABLES
-- ==============================================
-- This migration adds role-based access control for master tables:
-- - countries, states, cities, step_ways, team_types
--
-- Roles:
...
-- ==============================================
-- 5. CREATE NEW ROLE-BASED POLICIES FOR MASTER TABLES
-- ==============================================
