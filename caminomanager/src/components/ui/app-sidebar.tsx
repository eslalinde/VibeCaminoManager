        ...
        {navGroups.map((group) => (
          ...
          >
            <SidebarGroup className="py-1">
              ...
              <CollapsibleContent>
                <SidebarGroupContent>
                  <SidebarMenu className="border-l border-sidebar-border ml-4 pl-2 w-[calc(100%-1.5rem)] group-data-[collapsible=icon]:ml-0 group-data-[collapsible=icon]:border-l-0 group-data-[collapsible=icon]:pl-0 group-data-[collapsible=icon]:w-full">
