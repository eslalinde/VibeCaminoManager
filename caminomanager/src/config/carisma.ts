...
export const CARISMA_BADGE_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  'Viudo/a': { bg: 'bg-slate-100', text: 'text-slate-800' },
  'Soltero/a': { bg: 'bg-gray-100', text: 'text-gray-800' },
  'Matrimonio': { bg: 'bg-pink-100', text: 'text-pink-800' },
};
